...
-(id)initWithIconArray:(NSArray*)icons titleArray:(NSArray*)titles action:(void(^)(NSInteger index))action
{
    ...
    if (self) {
        ...
        label.textColor = [UIColor colorWithWhite:180/255.0f alpha:1];
        [blackView addSubview:label];
        
        UILabel * label2 = [[UILabel alloc] initWithFrame:CGRectMake(10, 55, self.frame.size.width-20, 20)];
        label2.backgroundColor = [UIColor clearColor];
        label2.text = @"手机上没有任何可分享的平台";
        label2.textAlignment = NSTextAlignmentCenter;
        label2.font = [UIFont systemFontOfSize:18];;
        label2.textColor = [UIColor colorWithWhite:180/255.0f alpha:1];
        ...
        cancalB.titleLabel.font = [UIFont systemFontOfSize:18];
        [blackView addSubview:cancalB];
        float width = (kScreenWidth-20)/icons.count;
